			...
			?>
				<tr class="fluid_2cl_tr">
						...
						<div class="fluid_provider">
							...
							<div class="mobile_tracker_img">
								...
								if ( $ast_preview ) {
									...
									?>
									<img class="<?php echo esc_attr( $fluid_tracker_class ); ?> mobile_tracker_image" src="<?php echo esc_url( ast_pro()->plugin_dir_url() ); ?>assets/images/mobile_<?php echo esc_attr( $fluid_tracker_type ); ?>.png"></img>
									<?php
								} else {
									if ( 'hide' != $fluid_tracker_type ) {
										?>
											
										<img class="mobile_tracker_image" src="<?php echo esc_url( ast_pro()->plugin_dir_url() ); ?>assets/images/mobile_<?php echo esc_html( $fluid_tracker_type ); ?>.png"></img>						
										<?php
									}
								}
								?>
					...
					<td class="fluid_2cl_td_action">
						<a href="<?php echo esc_url( $tracking_item['ast_tracking_link'] ); ?>" class="track-button"><?php echo esc_html( $fluid_button_text ); ?></a>
					</td>
				</tr>
				...
				if ( $ast_preview ) {
					$fluid_tracker_class = ( 'hide' == $fluid_tracker_type ) ? 'hide' : '';
					?>
					<tr class="desktop_tracker_img tracker_tr <?php echo esc_attr( $fluid_tracker_class ); ?>">
						<td colspan="2" class="fluid_2cl_td_image" style="padding-top:5px !important;">
							<img class="tracker_image " style="width:100%;" src="<?php echo esc_url( ast_pro()->plugin_dir_url() ); ?>assets/images/<?php echo esc_attr( $fluid_tracker_type ); ?>.png"></img>
						</td>	
					</tr>	
					<?php
				} else {
					if ( 'hide' != $fluid_tracker_type ) {
						...
						<tr class="desktop_tracker_img tracker_tr">
							<td colspan="2" class="fluid_2cl_td_image <?php echo esc_attr( $fluid_tracker_type ); ?>" style="padding-top:5px !important;">
								<img class="tracker_image" style="width:100%;" src="<?php echo esc_url( ast_pro()->plugin_dir_url() ); ?>assets/images/<?php echo esc_attr( $fluid_tracker_type ); ?>.png"></img>
							</td>					
						</tr>						
						<?php
