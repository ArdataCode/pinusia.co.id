jQuery(document).ready(function($) {
	...
	// Enable Feature Image as First Image.
...
jQuery(document).ready(function($) {
	...
	if ($("#pv_select_gallery_template_option").val()=='woo_gallery_template') {
		$('#pv_gallery_thumbnail_position').closest('tr').show('slow');
		$('#pv_gallery_thumbnail_to_show').closest('tr').show('slow');
		$('#pv_gallery_thumbnail_to_scroll').closest('tr').show('slow');
		$('#pv_arrows_gallery_controller').closest('tr').show('slow');
		$('#pv_dots_gallery_controller').closest('tr').show('slow');
		$('#afpv-play-icon-box').closest('tr').show('slow');
		$('#pv_play_icon').closest('tr').show('slow');
		$('#pv_product_page_thumbnails_width').closest('tr').hide('slow');

	} else {
		$('#pv_gallery_thumbnail_position').closest('tr').hide('slow');
		$('#pv_gallery_thumbnail_to_show').closest('tr').hide('slow');
		$('#pv_gallery_thumbnail_to_scroll').closest('tr').hide('slow');
		$('#pv_arrows_gallery_controller').closest('tr').hide('slow');
		$('#pv_dots_gallery_controller').closest('tr').hide('slow');
		$('#afpv-play-icon-box').closest('tr').hide('slow');
		$('#pv_play_icon').closest('tr').hide('slow');
		$('#pv_product_page_thumbnails_width').closest('tr').show('slow');
}
