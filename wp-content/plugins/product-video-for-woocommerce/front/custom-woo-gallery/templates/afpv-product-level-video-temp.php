			...
			<?php if ('youtube' == $video_type) { // Youtube Video Came From Product Level. ?>
				...
				<?php if (!empty($afpv_video_thumb)) { ?>
					...
					<div class="video-thumbnail" href="https://www.youtube.com/embed/<?php echo esc_attr($yt_video_id); ?>" data-width="900" data-height="600">
						...
						<img src="<?php echo esc_url($afpv_video_thumb); ?>" class="afpv-product-video-thumbnail-image"
						style="height:<?php echo esc_attr($afpv_tp_video_height); ?> !important; width:<?php echo esc_attr($afpv_tp_video_width); ?> !important; " />
				...
				<?php if (!empty($afpv_video_thumb)) { ?>
					...
					<div class="video-thumbnail" href="<?php echo esc_url($cus_video_id); ?>"  data-width="900" data-height="600">
						...
						<img src="<?php echo esc_url($afpv_video_thumb); ?>" class="afpv-product-video-thumbnail-image"
						style="height:<?php echo esc_attr($afpv_sh_video_height); ?> !important; width:<?php echo esc_attr($afpv_sh_video_width); ?> !important; " />
		...
		if ( 'yes' == $afpv_enable_featured_image_as_first_img) { 
			...
			if ( $product->is_type('variable')) {
				...
				foreach ( $variations as $variation ) {
					...
					<img class="afpv-hide-swatches" src="<?php echo esc_url($image_url); ?>" id="afpv_var_ids_<?php echo esc_attr( $variation_id ); ?>" >
			...
			?>
				...
				<?php if ( 'yes' == $afpv_enable_featured_image_as_first_img) { ?>
					...
					// Loop through each variation
						...
						<img class="afpv-var-hide-swatches" src="<?php echo esc_url($image_url); ?>" id="afpv_var_id_<?php echo esc_attr( $variation_id ); ?>" >
