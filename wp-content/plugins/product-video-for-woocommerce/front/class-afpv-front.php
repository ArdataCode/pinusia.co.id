...
if ( !class_exists( 'Addify_Product_Videos_Front' ) ) {
	...
	class Addify_Product_Videos_Front extends Addify_Product_Videos {
		...
		public function afpv_front_script() {
			...
			if ( is_post_type_archive( 'product' ) || is_product_category() || is_product_tag() || is_product() ) {
				...
				if ( 'woo_gallery_template' == $afpv_gallery_option || '' == $afpv_gallery_option ) {
					...
					wp_enqueue_script( 'afpv-front', plugins_url( '/js/afpv-custom-gallery.js', __FILE__ ), array( 'jquery' ), '1.0.0', false );

				} elseif ( 'html5_lightbox_template' == $afpv_gallery_option  ) {
					
					wp_enqueue_script( 'afpv-html5-gallery', plugins_url( '/js/afpv-html5-gallery.js', __FILE__ ), array( 'jquery' ), '1.0.0', false );
				}
				...
				if ( ( 1 == $afpv_enable_featured_video && 'yes' == $afpv_enable_featured_video_product_page ) || count($attached_product_videos ) > 0 ) {
					...
					if ( 'woo_gallery_template' == $select_gallery_temp || '' == $select_gallery_temp ) {
						...
						if ( '1' == get_option('pv_product_page_edited') ) {
							...
							add_action( 'woocommerce_product_thumbnails', array($this, 'afpv_custom_woo_gallery_template'), 20 );

						}

					} elseif ('html5_lightbox_template' == $select_gallery_temp) {
		...
		public function afpv_woo_display_embed_video( $html ) {
			...
			$afpv_tp_video_width    = '' == $afpv_tp_video_width  ? '100%' : $afpv_tp_video_width . 'px';
			$afpv_tp_video_height   = '' == $afpv_tp_video_height ? '100%' : $afpv_tp_video_height . 'px';
			...
			<div class="woocommerce-product-gallery images">
						...
						<?php if ('youtube' == $video_type) { ?>
							...
							<?php if (!empty($afpv_video_thumb)) { ?>
								...
								<a href="https://www.youtube.com/embed/<?php echo esc_attr($yt_video_id); ?>" class="html5lightbox" data-width="900" data-height="600">
									...
									<img src="<?php echo esc_url($afpv_video_thumb); ?>" style="height:<?php echo esc_attr($afpv_tp_video_height); ?> !important; width:<?php echo esc_attr($afpv_tp_video_width); ?> !important; "  />
						...
						<?php } elseif ( 'metacafe' == $video_type) { ?>
							...
							<?php if (!empty($afpv_video_thumb)) { ?>
								...
								<a href="http://www.metacafe.com/embed/<?php echo esc_attr($mc_video_id); ?>" class="html5lightbox" data-width="900" data-height="600">
									...
									<img src="<?php echo esc_url($afpv_video_thumb); ?>" style="height:<?php echo esc_attr(get_option('pv_featured_tp_video_height_productpage')); ?> !important; width:<?php echo esc_attr($afpv_tp_video_width); ?> !important; "  />
						...
						<?php } elseif ( 'custom' == $video_type) { ?>
							...
							<?php if (!empty($afpv_video_thumb)) { ?>
								...
								<a href="<?php echo esc_url($cus_video_id); ?>" class="html5lightbox" data-width="900" data-height="600">
									...
									<img src="<?php echo esc_url($afpv_video_thumb); ?>" style="height:<?php echo esc_attr($afpv_sh_video_height); ?> !important; width:<?php echo esc_attr($afpv_sh_video_width); ?> !important; "  />
				...
				<div class="thumbnails Addify_Product_Videos-thumbnails afpv-pro-thumb columns-<?php echo esc_attr($columns); ?> ">
					...
					if ( 'yes' == $afpv_enable_featured_image_as_first_img) { 
						...
						<a href="<?php echo esc_url(get_the_post_thumbnail_url()); ?>" class="zoom html5lightbox pv-thumbnail-width afpv-product-feature-img" data-width="900" data-height="600">

							<img class="afpv-product-feature-img attachment-shop_thumbnail size-shop_thumbnail" src="<?php echo esc_url( get_the_post_thumbnail_url()); ?>" width="<?php echo esc_attr($afpv_tp_video_width); ?>" height="<?php echo esc_attr($afpv_tp_video_height); ?>" />
							...
							// Variation Swatches.
								...
								foreach ( $variations as $variation ) {
									...
									$afpv_product = wc_get_product($variation_id);

									$image_id = $afpv_product->get_image_id();
								
									$image_url = wp_get_attachment_url($image_id);

									?>

								<a href="<?php echo esc_url($image_url); ?>" class="zoom afpv-hide-swatches html5lightbox pv-thumbnail-width" id="afpv_var_ids_<?php echo esc_attr( $variation_id ); ?>" data-width="900" data-height="600">

									<img class="attachment-shop_thumbnail size-shop_thumbnail" src="<?php echo esc_url($image_url); ?>" id="afpv_var_ids_<?php echo esc_attr( $variation_id ); ?>" width="<?php echo esc_attr($afpv_tp_video_width); ?>" height="<?php echo esc_attr($afpv_tp_video_height); ?>">
