...
<div class="woocommerce-product-rating">
	...
	if ( apply_filters( 'alpha_single_product_show_review', comments_open() && 'widget' != alpha_wc_get_loop_prop( 'product_type' ) ) ) { // Filters the review of product loop.
		echo alpha_get_rating_link_html_for_product_loop( $product );
	}
	?>
</div>
