						...
						switch ( $column_id ) {
							case 'thumbnail':
								...
								$value          = '<td class="product-thumbnail grouped-thumb">';
									$value     .= '<a href="' . esc_url( $grouped_product_child->get_permalink() ) . '">';
							...
							case 'label':
								...
								break;
							case 'price':
								$value  = '<td class="price-column" data-title="' . esc_attr__( 'Price', 'alpha' ) . '">';
							...
							case 'quantity':
								...
								echo '<td class="product-quantity" data-title="' . esc_attr__( 'Quantity', 'alpha' ) . '">';
