...
<form class="woocommerce-EditAccountForm edit-account row" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide mb-3">
		...
		<input type="text" class="woocommerce-Input woocommerce-Input--text input-text mb-2" name="account_display_name" id="account_display_name" value="<?php echo esc_attr( $user->display_name ); ?>" /> <span><em><?php esc_html_e( 'This will be how your name will be displayed in the account section and in reviews', 'alpha' ); ?></em></span>
	</p>
	<div class="clear"></div>
	...
	<fieldset>
		...
		<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide mb-3">
			<label for="password_2" class="text-body"><?php esc_html_e( 'Confirm new password *', 'alpha' ); ?></label>
	...
	<p class="mb-6">
		...
		<button type="submit" class="woocommerce-Button button btn btn-dark btn-rounded btn-sm" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'alpha' ); ?>"><?php esc_html_e( 'Save changes', 'alpha' ); ?></button>
